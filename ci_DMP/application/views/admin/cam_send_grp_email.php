...
<div style="width:100%;">
 <!-- Content Header (Page header) -->
        ...
        <section class="content">
				<?php echo form_open("Welcome/select_usersms_master_grp_email/"); ?>		
         <div class="row">
		 <div class="col-xs-12"> 
		  ...
		  <div class="col-xs-5">  
			...
			<div class="form-group">
				<div class="col-sm-5">
					...
					<div class="col-sm-7">
					<select name="email_template" class="form-control" style="margin-top:0px; margin-left: -15%;">
					<?php
					$query = $this->db->get('tbl_email');						

						foreach ($query->result() as $row)
						{  ?>
							<option value="<?php echo $row->file_path; ?>"><?php echo $row->title; ?></option>
						<?php 	} 		?>	
					</select>
				</div>
			</div> 
...
function search_group() { 
	...
	$.ajax({
            url : "<?php echo base_url(); ?>index.php/welcome/search_group_email", // my controller :<?php echo base_url(); ?>admin/order/new_order
            method: "POST",
            data: "id="+x,

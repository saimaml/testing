...
<section class="content">
	...
	<?php echo form_open_multipart("welcome/edit_profile"); ?>
			...
			<div class="box box-warning" style=" height: 650px;">
					...
					<?php foreach($posts as $results){?>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="land_line2" name="land_line2" placeholder="Enter Landline No.2" required value="<?php echo $results->land_line2;?>"/>
								</div>
							</div>	<br/><br/>
							<div class="form-group">

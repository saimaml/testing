...
{	
$i = 0;
$query = "select c.id, c.quantity, c.rate,s.rate_title,s.image, s.plan_name from tbl_cart as c, tbl_service_plans as s where c.product_id = s.id and c.session_id = '".$session_id."' group by c.id ";
$result = mysqli_query($con,$query);

...
$weight_id = mysqli_real_escape_string($con,$weight_id);
$sql_attribute = "SELECT product_id FROM tbl_product_attribute WHERE weight_id = '".$weight_id."'";
$result_attribute = mysqli_query($con,$sql_attribute);
$row_attribute = mysqli_fetch_array($result_attribute);

$sql_product = "SELECT id,plan_name,rate,image FROM tbl_service_plans WHERE id = '".$row_attribute['product_id']."'";
